---
title: 2017 Google Summer of Code - Port Cricket to use Toga, instead of <nospell>Tkinter</nospell>
date: 2017-08-25
authors:
- Dayof
categories:
...
- [PR 206](https://github.com/beeware/toga/pull/206) : \[Core\]\[Cocoa\] Read-only and placeholder for `MultilineTextInput` widget
...
- [Issue 205](https://github.com/beeware/toga/issues/205) : adding `MultilineTextInput` results in `TypeError`
...
I truly believe that [Toga](/docs/index.md#toga) will be the official framework on Python to build GUI for multi-platform applications, so I'll continue to contribute to this project because I want to use in every application that I would need a GUI.
