...
- We've fixed some canvas bugs that were causing problems on Windowns with our native Matplotlib rendering backend, [toga-chart](https://github.com/beeware/toga-chart).
