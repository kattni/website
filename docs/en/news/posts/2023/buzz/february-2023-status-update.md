...
- We [formalized the relationship between Toga's Pack layout model and CSS](https://github.com/beeware/toga/pull/1778). This should make it a lot easier to determine what "correct" layout behavior should be.
