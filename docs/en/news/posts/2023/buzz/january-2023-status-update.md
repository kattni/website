...
- Chaquopy [had a new release.](https://chaquo.com/chaquopy/chaquopy-version-14-0-2/), significantly improving build times on Android, improving the rendering of `stdout` content in the Android logs, adding some features that make it easier to expose the original project source code in the running app bundle, and enabling PEP517 builds of project dependencies.
