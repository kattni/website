...
- We released [Rubicon ObjC 0.4.7](https://pypi.org/project/rubicon-objc/0.4.7/), formalising our support for Python 3.12.
...
3. [Rationalise the application of adhoc signing on macOS](https://github.com/beeware/briefcase/issues/1099)
