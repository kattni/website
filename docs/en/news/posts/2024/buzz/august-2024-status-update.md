...
- We released [Toga 0.4.6](https://pypi.org/project/toga/0.4.6/). This includes the support for document-based apps, status icon apps, and a number of other long-awaited features, such as apps without menubars, available in a stable release.
