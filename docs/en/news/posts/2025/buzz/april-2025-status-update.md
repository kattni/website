...
- We modified CPython's usage of the HACL\* hashing library to [use a safer memory clearing implementation on iOS](https://github.com/python/cpython/pull/133226).
...
- We added [support for visionOS](https://github.com/beeware/Python-Apple-support/pull/270); support for MacCatalyst [is also underway](https://github.com/freakboy3742/cpython/pull/8).
